...
<head>
		...
		<title>Demo Digital Agency | Porto - Responsive HTML5 Template 5.1.0</title>	
		...
		<!-- Skin CSS -->
		<link rel="stylesheet" href="css/skins/skin-digital-agency.css">		<script src="master/style-switcher/style.switcher.localstorage.js"></script> 

		<!-- Demo CSS -->		<link rel="stylesheet" href="css/demos/demo-digital-agency.css">
							...
							<div class="header-column">
								<div class="header-logo">
									<a href="demo-digital-agency.html">
										<img alt="Porto" width="200" height="50" src="img/demos/digital-agency/logo-digital-agency.png">
									</a>
								</div>
							</div>
							<div class="header-column">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-content">
											<h3 class="heading-text-color font-weight-normal">Registered Workers</h3>
